...
function setup() {
  ...
  elbow = createVector(
    LENGTH * cos(shoulderAngle),
    LENGTH * sin(shoulderAngle),
    0
  );
  wrist = createVector(
    elbow.x + LOWERARM_LENGTH * cos(shoulderAngle + elbowAngle),
    elbow.y + LOWERARM_LENGTH * sin(shoulderAngle + elbowAngle),
    LOWERARM_LENGTH
  );
}
